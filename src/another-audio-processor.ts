...
class AnotherAudioProcessor extends AudioWorkletProcessor implements AudioWorkletProcessorImpl {
    ...
    constructor() {
        ...
        this.port.postMessage(this.myClass.sayHello("Frank"));
        console.log("AnotherAudioProcessor: This will also not be printed on WebKit")
    }
...
registerProcessor("another-audio-processor", AnotherAudioProcessor)